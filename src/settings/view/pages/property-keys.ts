...
export function renderPropertyKeysPage(container: HTMLElement, context: SettingsTabContext): void {
  ...
  identifierRow(
    mealCard,
    context,
    { name: t('settings.mealView.reheatTempProperty') },
    () => settings.reheatTempProperty,
    (value) => (settings.reheatTempProperty = value)
  );
  identifierRow(
    mealCard,
    context,
    { name: t('settings.mealView.reheatApplianceProperty') },
    () => settings.reheatApplianceProperty,
    (value) => (settings.reheatApplianceProperty = value)
  );
  identifierRow(
    mealCard,
    context,
