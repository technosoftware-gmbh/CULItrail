  ...
  return [
    ...
    },
    {
      ...
      properties: {
        ...
        // States a temperature and an appliance and no body section, which is
        // the ordinary shape now: the supplier's wording below is what turns
        // these two values into something a person can act on.
        [settings.reheatTempProperty]: '160 °C',
        [settings.reheatApplianceProperty]: 'oven',
        [settings.mealLineProperty]: 'Alltag',
    ...
    {
      // A note nobody wrote for CULItrail. `cook:` rather than the configured
      // reheat-time name, `yield:` rather than servings, `cover:` rather than
