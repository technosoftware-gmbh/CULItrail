...
export const deTranslations = {
  settings: {
    ...
    badges: {
      ...
      formula: 'Formel',
      formulaDesc:
        'Ein Ausdruck über die Eigenschaften der Notiz, etwa (reheatTime || 0) * 2 || null. Ergibt er null, wird der Chip ausgeblendet.',
      icon: 'Symbol',
      color: 'Farbe',
    ...
    mealView: {
      ...
      reheatTempProperty: 'Aufwärmtemperatur',
      reheatApplianceProperty: 'Aufwärmgerät',
  ...
  meals: {
    ...
    editor: {
      ...
      basicInfo: 'Eckdaten',
      reheatTime: 'Aufwärmen (Minuten)',
      reheatTemp: 'Aufwärmtemperatur',
      reheatAppliance: 'Aufwärmen im',
      noAppliance: 'Nicht angegeben',
      unknownAppliance: '{name} (nicht in deiner Geräteliste)',
      servings: 'Portionen',
      price: 'Preis',
