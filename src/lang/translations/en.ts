...
export const enTranslations = {
  settings: {
    ...
    badges: {
      ...
      formula: 'Formula',
      formulaDesc:
        "An expression over the note's properties, such as (reheatTime || 0) * 2 || null. A result of null hides the badge.",
      icon: 'Icon',
      color: 'Colour',
    ...
    mealView: {
      ...
      reheatTempProperty: 'Reheat temperature',
      reheatApplianceProperty: 'Reheat appliance',
      dietProperty: 'Diet',
  ...
  meals: {
    ...
    editor: {
      ...
      reheatTime: 'Reheat (minutes)',
      reheatTemp: 'Reheat temperature',
      reheatAppliance: 'Reheat in',
      noAppliance: 'Not stated',
      unknownAppliance: '{name} (not in your appliance list)',
      servings: 'Servings',
      price: 'Price',
